<template>
    <div class="modal-background">
        ...
        <div class="modal-body">
            <div v-if="showEditMessage" class="w-full h-full">
            ...
            <div v-else class="flex w-full h-full justify-center items-center">
                ...
                <div v-else>
                    <div v-if="goodResponse" class="w-full h-auto">
                        <div class="modal-header">
                            Success!
                        </div>
                        ...
                        <div class="modal-buttons">
                            <button class="save w-24" @click="closePopUpSuccess">OK</button> 
                        </div>
                    </div>
                    <div v-else class="w-full h-auto">
                        ...
                        <div class="modal-buttons">
                            <button class="cancel w-24" @click="closePopUp">OK</button> 
                        </div> 
                    </div>                    
                </div>            
            </div>
...
<script setup>
    ...
    const emit = defineEmits(["closeModal","closeModalSucess"])
    const { id_album, release, genres, styles }  = defineProps(['id_album','release','genres','styles'])
    const types = {
      'Album' : 1,
      'Single' : 2,      
      'Compilation': 3,
...
<style scoped>
    ...
    .modal-body{
        @apply bg-emerald-950 text-white rounded-lg p-5 flex flex-row flex-wrap;
